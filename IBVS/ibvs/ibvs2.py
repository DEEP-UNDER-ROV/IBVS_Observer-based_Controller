...
from geometry_msgs.msg import PolygonStamped, TwistStamped, WrenchStamped, PointStamped
...
from .estimator_pos import UKF_Estimator
...
class IBVSRCController(Node):
    ...
    # =========================================================
    def publish_position(self, pub, frame, stamp, pos):
        msg = PointStamped()
        msg.header.stamp = stamp
        msg.header.frame_id = frame
